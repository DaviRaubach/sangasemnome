...
def after_the_wind_pitches(mat: muda.Material):
    ...
    pb = muda.filter_pitches(
        multi_77_mod + multi_1,
        abjad.PitchRange(ranges[mat.name])
    )
    ...
    p_for_each_mat = int(len(lts)/3)

    c_mat_pitches = pitchesA[:p_for_each_mat] + \
        pitchesB[:p_for_each_mat] + \
        pitchesC[:p_for_each_mat]
    # pitchesD[:p_for_each_mat]

    # c_mat_pitches = {
    #     all_voices[0]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[1]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[2]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[3]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[4]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[5]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[6]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[7]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[8]: pitchesA + pitchesB + pitchesC + pitchesD,
    #     all_voices[9]: pitchesA + pitchesB + pitchesC + pitchesD,
    # }
    ...
    for name, _pitches in zip(all_voices, instruments_pitches):
        if name == mat.name and _pitches:
            ...
            # c_pitches = muda.filter_pitches(_pitches range)

            annotated_pitches = {"a": _pitches,
                                 "b": _pitches[2:], "c": c_mat_pitches}
            mat.write_pitches_by_name(annotated_pitches)
