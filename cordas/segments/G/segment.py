...
import muda
import abjad
from cordas.segments.G import rhythm_canon, timespans, pitch_canon2, pitch_canon, indicators_canon
from cordas import score_template, score_template_G, parts_templates
...
def main(call_by_material=None):
    ...
    segment = muda.Segment(
        modules=[rhythm_canon, pitch_canon2, indicators_canon],
    ...
    if call_by_material is not None:
        ...
        segment()
        # segment.call_by_material(all_voices[:4] + all_voices[6:8] + ["Global_Context"])
