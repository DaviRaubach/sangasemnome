...
def after_the_wind_pitches(mat: muda.Material):
    ...
    multi_1 = [-6.5, 11.5, 18.25,  0, 4, 25, 38.75]
    ...
    multi_31 = [6.75, 31,  20, 8, 27, 29]  # notas originais
    ...
    # instruments_pitches = [
    #     instruments_pitches[0],
    #     instruments_pitches[0],
    #     instruments_pitches[1],
    #     instruments_pitches[1],
    #     instruments_pitches[2],
    #     instruments_pitches[2],
    #     instruments_pitches[3],
    #     instruments_pitches[3],
    #     instruments_pitches[4],
    #     instruments_pitches[5],
    #     instruments_pitches[6],
    #     instruments_pitches[7],
    #     instruments_pitches[8],
    #     instruments_pitches[9],
    #     ]
...
after_the_wind_pitches.apply_to = all_voices[-2:]
