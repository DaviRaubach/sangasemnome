import muda
import abjad
from . import materials, multi_pitches
...
def transpose_neiborgh_octaves(pitches, pitch_range):
    """Transpose pitches outside a pitch range by an octave in order to get them inside the pitch range."""
...
def sx(mat: muda.Material):
    ...
    mat.write_chords_pitches(
        ...
        [
            multi_pitches.multi_31,
            multi_pitches.multi_31,
            multi_pitches.multi_1,
            multi_pitches.multi_1,
            multi_pitches.multi_77,
            multi_pitches.multi_31,
            multi_pitches.multi_77,
            multi_pitches.multi_31,
        ]
...
def vc_pitch(mat: muda.Material):
    ...
    if mat.name == "Vl1_Voice_1":
        abjad.mutate.transpose(mat.container, +14)
...
vc_pitch.apply_to = [all_voices[0], all_voices[4], all_voices[6]]
