...
def orch():
    ...
    # _connection = current_dir + "/orchestration/connection_bcl07_dyn1.txt"
    _connection = current_dir + "/orchestration/connection_bcl07-2.txt"
    # _connection = current_dir + "/orchestration/connection_after2.txt"
