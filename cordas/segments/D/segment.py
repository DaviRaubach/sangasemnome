...
import os
import muda
from cordas.segments.D import rhythm, timespans, pitch, indicators
...
def main(call_by_material=None):
    ...
    # segment.call_by_material(["Vl1_Voice_1", "Vl1_Voice_2"])
    # segment.call_by_material(all_voices[-4:])
...
if __name__ == "__main__":
    ...
    # segment.score.save_ly(
        # file_name="score.ly", output_dir=os.path.dirname(__name__)
    # )
